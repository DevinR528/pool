/*
g++ -fcoroutines -std=c++20 -Wall -Werror coro.cc
...
struct ReturnObject3 {
	struct promise_type {
		...
		ReturnObject3 get_return_object() {
			return ReturnObject3{.h_ = std::coroutine_handle<promise_type>::from_promise(*this)};
		}
		std::suspend_never initial_suspend() { return {}; }
		std::suspend_never final_suspend() noexcept { return {}; }
		void unhandled_exception() {}
...
struct ReturnObject5 {
	struct promise_type {
		...
		void return_value(unsigned i) { value_ = i; }
	};
